...
def init(
  ...
  fn = jax.jit(fn, in_shardings=arg_shardings, out_shardings=params_sharding, static_argnums=static_argnums) # changed for new jax version
...
def apply(
  ...
  fn = jax.jit(fn, in_shardings=in_shardings, out_shardings=out_shardings, static_argnums=static_argnums, donate_argnums=donate) # changed for new jax version
